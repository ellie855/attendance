...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reports/monthly/csv',                           [ReportController::class, 'monthlyCsv'])->middleware('subscribed')->name('reports.monthly.csv');
    ...
    Route::get('/billing/manage',                                [\App\Http\Controllers\BillingController::class, 'manage'])->name('billing.manage');
